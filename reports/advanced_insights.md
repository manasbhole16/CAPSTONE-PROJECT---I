...
**I4 — Sector Concentration (HHI):** 'Axis Bluechip Fund - Regular -' is the most concentrated equity fund (HHI=2968) with 48.7% in IT. In contrast, 'UTI Mid Cap Fund - Regular - G' is the most diversified (HHI=1240 across 10 sectors). Concentrated funds carry higher sector-specific risk.

**I5 — Risk-Adjusted vs Raw Risk:** The top-ranked scorecard fund 'ICICI Pru Midcap Fund - Regular - Growth' demonstrates consistent rolling Sharpe above 1.0, indicating stable risk-adjusted performance over time. Meanwhile, 'ICICI Pru Liquid Fund - Regular - Growth' shows the lowest daily VaR, confirming it as a capital-preservation choice for conservative investors. Investors should match fund selection to both risk tolerance and time horizon.